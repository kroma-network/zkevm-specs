...
from ...util import FQ, N_BYTES_WORD, PROTOCOL_VAULT, VALIDATOR_REWARD_VAULT, VALIDATOR_REWARD_DENOMINATOR
...
def fee_distribution_hook(instruction: Instruction):
    ...
    validator_reward_tmp = instruction.rlc_encode(total_reward.int_value * validator_reward_numerator.int_value, N_BYTES_WORD)

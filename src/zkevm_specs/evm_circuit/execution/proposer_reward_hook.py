...
from ...util import FQ, N_BYTES_WORD, L1_COST_DENOMINATOR, PROPOSER_REWARD_VAULT, VALIDATOR_REWARD_DENOMINATOR
...
def proposer_reward_hook(instruction: Instruction):
    ...
    l1_fee_tmp = instruction.rlc_encode(l1_gas_to_use.int_value * l1_base_fee.int_value, N_BYTES_WORD)
    instruction.mul_add_words(l1_gas_to_use, l1_base_fee, zero, l1_fee_tmp)

    l1_fee_tmp2 = instruction.rlc_encode(l1_fee_tmp.int_value * l1_fee_scalar.int_value, N_BYTES_WORD)
    ...
    instruction.mul_add_words(l1_fee_rlc, l1_cost_denominator_rlc, l1_cost_remainder_rlc, l1_fee_tmp2)
    """
